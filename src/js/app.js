...
const API = {
  login: "https://api.auth.erzen.xyz/v1/auth/login",
  register: "https://api.auth.erzen.xyz/v1/auth/register",
  mfaSetup: "https://api.auth.erzen.xyz/v1/auth/mfa/setup",
  profile: "https://api.auth.erzen.xyz/v1/auth/info",
  security: "https://api.auth.erzen.xyz/v1/user/active-sessions",
  mfaVerify: "https://api.auth.erzen.xyz/v1/auth/mfa/verify",
  mfaSetupSecond: "https://api.auth.erzen.xyz/v1/auth/mfa/setup/verify",
  refresh: "https://api.auth.erzen.xyz/v1/auth/refresh",
  logout: "https://api.auth.erzen.xyz/v1/auth/logout",
  password: "https://api.auth.erzen.xyz/v1/auth/change-password",
};
...
async function loadConnectedApps() {
  try {
    const response = await fetch(
      "https://api.auth.erzen.xyz/oauth/applications",
      {
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
...
async function revokeAccess(clientId, appName) {
  ...
  try {
    const response = await fetch("https://api.auth.erzen.xyz/oauth/revoke", {
      method: "POST",
      credentials: "include",
      headers: {
        "Content-Type": "application/json",
...
document
  ...
  .addEventListener("change", async (event) => {
    ...
    try {
      const response = await fetch(
        "https://api.auth.erzen.xyz/storage/upload",
        {
          // Updated endpoint
          method: "POST",
          headers: {
...
async function updateProfileImage(url) {
  try {
    const response = await fetch(
      "https://api.auth.erzen.xyz/v1/user/change-profilePicture",
      {
        method: "PATCH",
        credentials: "include",
        headers: {
